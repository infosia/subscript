...
use subscript_codegen::{host_c_compiler, tool_output_report, value_class_layouts};
...
/// (identical 8/8 layout); see the module comment.
...
// before the count-less pointer at +8, and a uint64_t alias at +16. This
// must remain 24 bytes with 8-byte alignment.
...
fn mirrored_structs() -> Vec<(&'static str, Vec<&'static str>)> {
    vec![
        ...
        // Production-scale additions (§13.4).
        ...
        // Composed async capstone (§14.4/§14.5).
