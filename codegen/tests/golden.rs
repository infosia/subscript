...
fn jit_ship_c_aot_and_golden_agree_byte_for_byte() {
    ...
    assert_eq!(
        golden_ids.len(),
        124,
        "expected exactly 124 committed goldens: the 81 standing goldens (a01–a24 run set + a25–a39 interop \
         ...
         golden, and the a124 R18 contextual-conditional golden, found {}",
        golden_ids.len()
    );
